...
![Web API](https://img.shields.io/badge/.NET_Web_API-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)
...
## 🍳 Clasificador de Ingredientes y Recetas  
**Python | PyTorch | OpenCV | Tkinter | Spoonacular API**  
Clasificación automática de ingredientes + traducción + recomendación de recetas.

---

## 🛒 E-asy Shopping  
**Flutter | Firebase | Cloud Firestore | OAuth2**  
